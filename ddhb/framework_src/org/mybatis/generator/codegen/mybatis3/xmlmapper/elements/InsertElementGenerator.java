    ...
    public void addElements(XmlElement parentElement) {
        ...
        while (iter.hasNext()) {
            ...
            String currentColumnName = MyBatis3FormattingUtilities
                .getEscapedColumnName(introspectedColumn).toUpperCase();
            String value;
            if(stringHasValue(keyColumnName) && keyColumnName.equalsIgnoreCase(currentColumnName)){
                value = "uuid()";
            }else if("OPER_TIME".equals(currentColumnName)){
                value = "now()";
            }else if("VALIDITY".equals(currentColumnName)){
                value = "${VALID}";
            }else{
