...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    //是否去除自动生成的注释 true：是 ： false:否  generatorConfig.xml commentGenerator
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine(" * create by "+"XT");
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        sb.append(" *  ");
        sb.append(introspectedTable.getFullyQualifiedTable().getRemarks());
        innerClass.addJavaDocLine(sb.toString());
        innerClass.addJavaDocLine(" * @author "+System.getProperty("user.name"));
        innerClass.addJavaDocLine(" * @date "+getVersionDate());
