package com.cht.framework.core.mybatis.jdbc.interceptor;
...
import com.cht.framework.core.mybatis.jdbc.dialect.Dialect;
import com.cht.framework.core.mybatis.jdbc.dialect.MySQLDialect;
...
public class MySQLStatementHandlerInterceptor implements Interceptor {

    private static final String DIALECT = "com.cht.framework.core.mybatis.jdbc.dialect.MySQLDialect";
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        //针对不同的数据库采用方言的形式进行物理分页(这里采用mysql进行分页)
        if (rowBounds.getLimit() > 0
                && rowBounds.getLimit() < RowBounds.NO_ROW_LIMIT) {
            BoundSql boundSql = statement.getBoundSql();
            String sql = boundSql.getSql();
            Dialect dialect = (MySQLDialect) Class.forName(DIALECT).newInstance();
