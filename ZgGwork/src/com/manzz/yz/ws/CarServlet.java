...
public class CarServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestParameter requestParameter = new RequestParameter("ZGYG_GetInfo", "Order_Get_CarQuery", JSONUtil.beanToJson(new Parameter(ssdq, ssxs, mc,begin,end,drivecode)));
	...
	public static void main(String[] args) {
	    RequestParameter requestParameter = new RequestParameter("ZGYG_GetInfo", "Order_Get_CarQuery", JSONUtil.beanToJson(new Parameter(null,null,null,null,null)));
        String resJson = HttpUtils.httpPost("http://manage.scjpw.com.cn/orderinterface/ZGYGService.aspx",JSONUtil.beanToJson(requestParameter));
