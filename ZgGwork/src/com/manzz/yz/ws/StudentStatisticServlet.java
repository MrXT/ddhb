 ...
 * 查询自贡下面统计的学生报名数据信息
 */
public class StudentStatisticServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentStatisticServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestParameter requestParameter = new RequestParameter("ZGYG_GetInfo", "Order_Get_StudentStatistic", JSONUtil.beanToJson(new Parameter(ssdq, ssxs, mc,begin,end)));
