...
public class Method extends JavaElement {
    ...
    // add
    private FullyQualifiedJavaType jsonSerializeType;
    // add
    private FullyQualifiedJavaType customDateSerializerType;
    ...
    /** customize system configuration */
    // add
    public void addDefaultReturnDateAnnotation(){
        initJsonSerializeType();
        initCustomDateSerializerType();
        addAnnotation("@" + getJsonSerializeType().getShortName()+"(using = " + getCustomDateSerializerType().getShortName() + ".class)");
    }
    // add
    private void initJsonSerializeType() {
        jsonSerializeType = new FullyQualifiedJavaType("com.fasterxml.jackson.databind.annotation.JsonSerialize");
    }
    // add
    private void initCustomDateSerializerType() {
        customDateSerializerType = new FullyQualifiedJavaType("com.manzz.framework.core.web.serializer.CustomDateSerializer");
    }
    // add
    public List<FullyQualifiedJavaType> getAnnotationTypeList(){
        ...
        list.add(getJsonSerializeType());
        list.add(getCustomDateSerializerType());
        return list;
    }
    ...
    /** customize system configuration */
    // add
    public FullyQualifiedJavaType getJsonSerializeType()
    {
        return jsonSerializeType;
    }
    // add
    public void setJsonSerializeType(FullyQualifiedJavaType jsonSerializeType)
    {
        this.jsonSerializeType = jsonSerializeType;
    }
    // add
    public FullyQualifiedJavaType getCustomDateSerializerType()
    {
        return customDateSerializerType;
    }
    // add
    public void setCustomDateTimeSerializerType(FullyQualifiedJavaType customDateTimeSerializerType)
    {
        this.customDateSerializerType = customDateTimeSerializerType;
    }
}
