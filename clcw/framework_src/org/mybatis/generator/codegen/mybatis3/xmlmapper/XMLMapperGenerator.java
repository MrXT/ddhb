...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.FuzzyWhereClauseElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.InsertSelectiveElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.QueryPagedListElementGenerator;
...
//        addUpdateByExampleWithoutBLOBsElement(answer);
        ...
        // modified
        addExampleWhereClauseElement(answer);
        addFuzzyWhereClauseElement(answer);
        addCountByExampleElement(answer);
    ...
    protected void addFuzzyWhereClauseElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSQLExampleWhereClause()) {
            AbstractXmlElementGenerator elementGenerator = new FuzzyWhereClauseElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addQueryPagedListElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new QueryPagedListElementGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
