 ...
 * @version 2015-08
 */
public class FuzzyWhereClauseElementGenerator extends
        AbstractXmlElementGenerator {
    /** project customize configuration 需要进行是否为空字符串判断的类型 */
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "Where_Fuzzy_Condition"));
